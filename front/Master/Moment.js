...
var obj = moment().endOf('week').subtract(1, 'days').format(Format);


function PayPeriodBegin() {
        var Format = "YYYY-MM-DD HH:mm:ss";
        var obj = moment().startOf('isoweek').subtract(1, 'days').format(Format);
        return obj;
    }
    function PayPeriodEnd() {
        var Format = "YYYY-MM-DD HH:mm:ss";
        var obj = moment().endOf('week').subtract(1, 'days').format(Format);
        return obj;
    }
